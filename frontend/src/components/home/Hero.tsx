...
const Hero = () => {
  ...
  return (
    <section
      className="relative pt-24 sm:pt-32 md:pt-40 pb-24 md:pb-32 overflow-hidden bg-cover bg-center" // Increased padding
      style={{
    ...
    >
      ...
      <div className="container mx-auto px-4 md:px-6 relative z-10"> {/* Content needs higher z-index */}
        {/* Content wrapper, now max-width to left align it within the container */}
        <div className="max-w-4xl lg:max-w-3xl text-left"> {/* Adjusted max-width and forced left alignment */}
          ...
          >
            ...
            <motion.h1
              ...
              className="text-4xl sm:text-5xl md:text-6xl lg:text-7xl font-bold leading-tight mb-6 uppercase tracking-wider" // Larger font sizes
              style={{ color: '#3C3C3C' }}
            >
            ...
            <motion.p
              ...
              className="text-lg md:text-xl lg:text-2xl mb-8 md:mb-10 max-w-2xl text-justify" // Larger font size and max-width for readability
            ...
            <div className="flex flex-wrap gap-6"> {/* Buttons remain left-aligned with content */}
              <Link to="/equipment">
                <motion.button
                  ref={buttonRef}
                  className="px-8 py-4 flex items-center gap-2 text-base uppercase font-semibold tracking-wider" // Larger button padding and font
                  style={{
                ...
                >
                  ...
                  >
                    <ArrowRight className="h-6 w-6" /> {/* Larger icon */}
                  </motion.div>
                </motion.button>
              </Link>
              <Link to="/contact">
                <Button
                  variant="secondary"
                  className="px-8 py-4 text-base uppercase font-semibold tracking-wider border transition-colors duration-300" // Larger button padding and font
                  style={{
                    color: '#593D2B',
                  ...
                  onMouseEnter={e => e.currentTarget.style.backgroundColor = '#593D2B'} // Hover effect
            ...
            <motion.div
              ...
              className="grid grid-cols-2 sm:grid-cols-3 gap-8 mt-16" // Increased gap and margin-top
            >
              <div className="flex flex-col">
                <span className="text-3xl font-bold mb-1" style={{ color: '#593D2B' }}>8+</span> {/* Larger numbers */}
